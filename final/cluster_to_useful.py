...
# Read in data
old_data = pd.read_csv("/Users/abigailhayes/Documents/IR/ir_ws_project/output/output_cluster.csv")
...
new_data.to_csv('/Users/abigailhayes/Documents/IR/ir_ws_project/output/output_narrow.csv')
